...
(function() {
	CRAFTWW.startAd = function() {
		...
		setPos(logo, "hidden", 19, 188, 4);
		setPos(copy_f6, "hidden", 19, 31, 5);
		setPos(copy_f7, "hidden", 19, 31, 6);
		setPos(copy_f8, "hidden", 19, 31, 7);
		setPos(copy_f9, "hidden", 19, 31, 8);
		setPos(copy_f10, "hidden", 19, 31, 9);
		setPos(legal, "hidden", 19, 204, 10);
