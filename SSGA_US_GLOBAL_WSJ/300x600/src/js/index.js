...
(function() {
	CRAFTWW.startAd = function() {
		...
		if(checkFallback()){
			...
			setPos(logo, "hidden", 26, 518, 4);
			setPos(copy_f6, "hidden", 26, 150, 5);
			setPos(copy_f7, "hidden", 26, 150, 6);
			setPos(copy_f8, "hidden", 26, 150, 7);
			setPos(copy_f9, "hidden", 26, 150, 8);
			setPos(copy_f10, "hidden", 26, 150, 9);
			setPos(legal, "hidden", 26, 522, 10);
			setPos(cta, "hidden", 26, 222, 11);
