...
(function(){
	CRAFTWW.startAd = function() {
		...
		if (checkFallback() ) {
			...
			function advance(){
				...
				if(phase === 2){
					...
					if( mq.matches ) {
						...
						rePosition(copy1, 334, 28, 0.5, 'ease-in-out', tweenDelay);
						rePosition(copy2, 498, 28, 0.5, 'ease-in-out', tweenDelay);
						rePosition(copy4, 532, 28, 0.5, 'ease-in-out', tweenDelay);
				...
				if(phase === 8){		
					...
					slideUp(frameLegal, "-90px", 10, 'easeOutCubic', 1);
				...
				console.log("phase 9");			
					...
					slideUp(frameLegal, "-170px", 10, 'easeOutCubic', 1);
				...
				console.log("phase 10");	
					...
					slideUp(frameLegal, "-223px", 10, 'easeOutCubic', 1);
			...
			setPos(frameLegal, "hidden", 0, 0, 22);
