...
(function(){
	CRAFTWW.startAd = function() {
		...
		if (checkFallback() ) {
			...
			function advance(){
				...
				if(phase === 2){
					...
					if( mq.matches ) {
						...
						rePosition(copy1, 104, 32, 0.5, 'ease-in-out', tweenDelay);
						rePosition(copy2, 305, 32, 0.5, 'ease-in-out', tweenDelay);
						rePosition(copy4, 330, 32, 0.5, 'ease-in-out', tweenDelay);

						fontsizeChange(copy1, 10, 'easeOutCubic', 0);
						fontsizeChange(copy2, 10, 'easeOutCubic', 0);				
						fontsizeChange(copy4, 10, 'easeOutCubic', 0);
						...
						rePosition(copy1, 100, 32, 0.5, 'ease-in-out', tweenDelay);
						rePosition(copy2, 262, 32, 0.5, 'ease-in-out', tweenDelay);
						rePosition(copy4, 294, 32, 0.5, 'ease-in-out', tweenDelay);					
				...
				if(phase === 8){		
					...
					slideUp(frameLegal, "-75px", 10, 'easeOutCubic', 1);
				...
				if(phase === 9){		
					...
					slideUp(frameLegal, "-140px", 10, 'easeOutCubic', 1);
				...
				if(phase === 10){		
					...
					slideUp(frameLegal, "-250px", 10, 'easeOutCubic', 1);
			...
			setPos(copy2, "visible", 456, 22, 3);
			setPos(copy3, "visible", 510, 45, 4);
			setPos(copy4, "visible", 456, 66, 5);

			setPos(frame7, "hidden", 0, 0, 8);
			setPos(frame8, "hidden", 0, 0, 9);
			setPos(frame9, "hidden", 0, 0, 20);
			setPos(frameLegal, "hidden", 0, -10, 22);
			setPos(frame10, "hidden", 0, 0, 11);		

			setPos(logo, "hidden", 0, 0, 1);
			setPos(border, "visible", 0, 0, 100);			
