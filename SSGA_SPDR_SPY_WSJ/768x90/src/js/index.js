...
(function(){
	CRAFTWW.startAd = function() {
		...
		setPos(frame7, "hidden", 165, 38, 8);
		setPos(frame8, "hidden", 331, 22, 9);
		setPos(frame9Legal, "hidden", 0, 0, 20);
		setPos(frame10, "hidden", 218, 24, 11);		

		setPos(logo, "hidden", 694, 50, 1);
		...
		function advance(){
			...
			if(phase === 2){
				...
				if( mq.matches ) {
					rePosition(copy1, -98, 37, 0.5, 'ease-in-out', tweenDelay);
					rePosition(copy3, -190, 37, 0.5, 'ease-in-out', tweenDelay);
					rePosition(copy4, 494, 37, 0.5, 'ease-in-out', tweenDelay);				
				} else {
					rePosition(copy1, -98, 37, 0.5, 'ease-in-out', tweenDelay);
					rePosition(copy3, -188, 37, 0.5, 'ease-in-out', tweenDelay);
					rePosition(copy4, 494, 37, 0.5, 'ease-in-out', tweenDelay);			
				}
			...
			if(phase === 7){		
				...
				slideUp(frame9Legal, "-85px", 1.5, 'ease-in-out', 0);
